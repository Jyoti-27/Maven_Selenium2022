...
public class IRCTC_Demo1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// driver.findElement(By.cssSelector("span[class='ui-datepicker-month
		// ng-tns-c58-10 ng-star-inserted']"));
		...
		while (!monthYear.getText().equalsIgnoreCase("July2022")) {
			...
			// driver.findElement(By.cssSelector("div[class='ui-datepicker-title
			// ng-tns-c58-10']")));
		...
		// WebElement table =
		// driver.findElement(By.cssSelector("input[class='ng-tns-c58-10 ui-inputtext
		// ui-widget ui-state-default ui-corner-all ng-star-inserted']"));
		
		List<WebElement> date = table.findElements(By.xpath("//tbody[@class='ng-tns-c59-10']/tr/td[not(contains(@class,'other-month'))]"));
				// .findElements(By.xpath("//tbody[@class='ng-tns-c59-10']/tr/td[not(contains(@class,'other-month'))]"));
				// List<WebElement> date = table
		...
		WebElement allclasses = driver.findElement(
				By.cssSelector(".ng-tns-c66-11.ui-dropdown-label.ui-inputtext.ui-corner-all.ng-star-inserted"));
		allclasses.click();
		Thread.sleep(2000);
		...
		for (WebElement element : checkbox) {
			element.click();
			List<WebElement> confirmation = driver
					.findElements(By.xpath("//div[contains(@class,'ui-dialog-titlebar')]"));
